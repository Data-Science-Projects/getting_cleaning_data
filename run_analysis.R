...
tidy_names <- function(df) {
  ...
  #Replace ".." wiith nothing, i.e. remove them
...
get_test_data <- function() {
  ...
  #Get the test data set, combine with subjects, set variable names to lower case and extract only the columns that are means or stds
...
get_train_data <- function() {
  ...
  #Get the training data set, combine with subjects, set variable names to lower case and extract only the columns that are means or stds
...
merge_data <- function(test_df, train_df) {
  merge(get_test_data(), get_train_data(), all = TRUE)
}
...
run_analysis <- function() {
  ...
  merged_data_tbl <- tbl_df(merged_data)  
